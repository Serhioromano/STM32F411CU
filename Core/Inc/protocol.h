...
******************************************************************************/
#define PRODUCT_KEY "zam0py2hav6hmmwt"    //The unique product identification generated after product is created on development platform

#define MCU_VER "1.0.1"         //User's software version for MCU firmware upgrade, MCU upgrade version needs to be modified
...
******************************************************************************/
//Current Pressure(Only report)
#define DPID_CUR_PRESS 101
//Set target pressure(Issue and report)
#define DPID_PRESS_SET 102
//Pupm state(Only report)
#define DPID_PUMP_STATE 103
//Enable pump(Issue and report)
#define DPID_PUMP_EN 104
//Sensor max. pressure(Issue and report)
#define DPID_SENS_MAX 105
//Set delta(Issue and report)
#define DPID_PRESS_DELATA 106
